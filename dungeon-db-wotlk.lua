...
dt_db = {
	...
	{ 389, 2437, "Ragefire Chasm", "D", 5, 1, { 18, 18 },
				{ 5728, 5761, 5723, 5724, 5725, 26858, 26856, 26862 }, 			-- "Searching for the lost satchel" replaced by "Returning the Lost satchel" because the former can be finished inside
				{{"Bazzalan",11519}, {"Taramagan the Hungerer",11520}, {"Oggleflint",11517}, {"Jergosh the Invoker",11518}}
	},
	{ 43, 718, "Wailing Caverns", "D", 5, 1, { 24, 22 },
				{ 914, 1487, 3366, 26870, 26878, 26874 },			-- Leaders of the Fang, Deviate Eradication, The Glowing Shard
	...
	{ 36, 1581, "The Deadmines", "D", 5, 1, { 26, 24, 18 },
	...
	{ 33, 209, "Shadowfang Keep", "D", 5, 1, { 30, 25, 23 },
	...
	{ 48, 719, "Blackfathom Deeps", "D", 5, 1, { 32, 28, 27 },
	...
	{ 90, 721, "Gnomeregan", "D", 5, 1, { 38, 32, 31 },
	...
	{ 129, 722, "Razorfen Downs", "D", 5, 1, { 46, 41, 47 },
	...
	{ 189, 796, "Scarlet Monastery", "D", 5, 1, { 45, 44, 41 },
				{}, 
				{} 																-- Empty boss list allows logging of bosses in the wings (do not touch!)
	},			
	{ 18901, 79601, "Scarlet Monastery (GY)", "D", 5, 1, { 45, 44, 33}, 	 		-- Bit of a hack here, the 4 wings don't have a separate ID, so we fake one for them
				{},																-- No quests in GY
				{ {"Bloodmage Thalnos", 4543}, {"Interrogator Vishas", 3983} }
	}, 
	{ 18902, 79602, "Scarlet Monastery (Lib)", "D", 5, 1, { 45, 44, 36 },
				{ 1050, 1053, 1049, 1048, 1160, 1951 }, 						-- 1048+1053: kill 4 bosses needs Lib+Cath+Arm
				{ {"Arcanist Doan", 6487}, {"Houndmaster Loksey", 3974} }
	}, 
	{ 18903, 79603, "Scarlet Monastery (Cath)", "D", 5, 1, { 45, 44, 41 },
	...
	{ 18904, 79604, "Scarlet Monastery (Arm)", "D", 5, 1, { 45, 44, 39 },
				{ 1053, 1048 },													-- 1048+1053: kill 4 bosses needs Lib+Cath+Arm
				{ {"Herod", 3975} } 
	},
	{ 70, 1137, "Uldaman", "D", 5, 1, { 51, 44, 42 },
	...
	{ 349, 2100, "Maraudon", "D", 5, 1, { 55, 52, 41 },
	...
	{ 109, 1477, "The Temple of Atal'Hakkar", "D", 5, 1, { 60, 54, 57 }, 
	...
	{ 230, 1584, "Blackrock Depths", "D", 5, 1, { 60, 60, 58 }, 
	...
	{ 289, 2057, "Scholomance", "D", 5, 1, { 60, 62, 45 }, 
	...
	{ 429, 2557, "Dire Maul", "D", 5, 1, { 60, 62, 49 }, 
	...
	{ 329, 2017, "Stratholme", "D",	5, 1, { 60, 62, 49 },
	...
	-- TBC dungeons
	{ 543, 3562, "Hellfire Ramparts", "D", 5, 1, { 1000, 64, 64 }, { 9575, 9572, 9587, 9588 } },
	{ 542, 3713, "The Blood Furnace", "D", 5, 1, { 1000, 65, 65 }, { 9607, 9608, 9589, 9590 } },
	{ 547, 3717, "The Slave Pens", "D", 5, 1, { 1000, 66, 66 }, { 9738 } },
	{ 546, 3716, "The Underbog", "D", 5, 1, { 1000, 66, 67 }, { 9738, 9717, 9719 } }, -- 9715 removed because also drops in Steamvault
	{ 557, 3792, "Mana-Tombs", "D", 5, 1, { 1000, 68, 68 }, { 10216, 10218, 10165 } },
	...
	-- WotLK dungeons
	{ 574, 206, "Utgarde Keep", "D", 5, 1, { 1000, 74, 74 }, { 11272, 13206, 11262, 13245, 13205, 11252 } },
	{ 576, 4265, "The Nexus", "D", 5, 1, { 1000, 75, 75 }, { 13094, 13095, 11905, 11911, 11973, 13246 } },
	{ 601, 4277, "Azjol-Nerub", "D", 5, 1, { 1000, 76, 76 }, { 13167, 13182, 13254 } },
	{ 619, 4494, "Ahn'kahet: The Old Kingdom", "D", 5, 1, { 1000, 77, 77 }, { 13187, 13204, 13190, 13255 } },
	{ 600, 4196, "Drak'Tharon Keep", "D", 5, 1, { 1000, 78, 78 }, { 12238, 12037, 13129, 13249 } },
	{ 608, 4415, "The Violet Hold", "D", 5, 1, { 1000, 79, 79 }, { 13158, 13159, 13256 } },
	{ 604, 4416, "Gundrak", "D", 5, 1, { 1000, 80, 80 }, { 13098, 13096, 13111, 13250 } },
	{ 599, 4264, "Halls of Stone", "D", 5, 1, { 1000, 80, 80 }, { 13207, 13252 } },
	{ 602, 4272, "Halls of Lightning", "D", 5, 1, { 1000, 80, 80 }, { 13109, 13108, 13244, 13253 } },
	{ 668, 4820, "Halls of Reflection", "D", 5, 1, { 1000, 80, 80 }, { 24713, 24711, 24802, 24500, 24561, 24480 } },
	{ 595, 4100, "The Culling of Stratholme", "D", 5, 1, { 1000, 80, 80 }, { 13151, 13149, 13240, 13251 } },
	{ 575, 1196, "Utgarde Pinnacle", "D", 5, 1, { 1000, 80, 80 }, { 13131, 13132, 13241, 13248 } },
	{ 578, 4228, "The Oculus", "D", 5, 1, { 1000, 80, 80 }, { 13124, 13126, 13127, 13128, 13240, 13247 } },
	{ 650, 4723, "Trial of the Champion", "D", 5, 1, { 1000, 80, 80 }, { 14199 } },
	{ 632, 4809, "The Forge of Souls", "D", 5, 1, { 1000, 80, 80 }, { 24506, 24510, 24511, 24499, 24682, 24683 } },
	{ 658, 4813, "Pit of Saron", "D", 5, 1, { 1000, 80, 80 },{ 24682, 24683, 24507, 24498, 24712, 24710, 24713, 24711, 24559, 24461 }},
	-- WotLK raids
